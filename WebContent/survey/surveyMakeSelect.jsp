	...
	<body>
		<div class="card-deck">
		  <div class="card" id="card1">
		    ...
		    <img src="/DotNet/save/two.jpg" class="card-img-top" alt="양자택일">
		    <div class="card-body">
		  ...
		  <div class="card">
		    <img src="/DotNet/save/five.jpg" class="card-img-top" alt="오지선다">
		    <div class="card-body">
		  ...
		  <div class="card">
		    <img src="/DotNet/save/eight.png" class="card-img-top" alt="8문8답">
		    <div class="card-body">
