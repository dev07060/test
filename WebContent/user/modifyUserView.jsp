	...
	<form name="memmodifyform" id="memmodifyform" method="post" action="modifyUserPro.do"
		...
		<div class="col-md-4">
			<table class="table table-hover">
				...
				<tr>
					<th>${str_age}</th>
					<td><label><h4>현재 설정 연령대 = ${memberDto.age}대</h4></label>
				...
				<tr>
					<th rowspan="3">주소</th>
					<td><input class="col-md-2" type="text" id="zipcode"
						name="zipcode" value="${memberDto.zipcode}"> <input
				...
				<tr>
					<th colspan="2"><input class="inputbutton" type="submit"
						value="${btn_mod}"> <input class="inputbutton"
						type="reset" value="${btn_cancel}"> <input
						class="inputbutton" type="button" value="${btn_mod_cancel}"
						onclick="location='mypage.do'"></th>
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<div class="modal-body">
								<input name="delpasswd" type="password"
