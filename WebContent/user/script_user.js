...
function memmodifycheck() {
	if( ! memmodifyform.passwd.value ) {
		...
		return false;
	} else if( memmodifyform.passwd.value != memmodifyform.repasswd.value ) {
		alert( repasswderror );
		memmodifyform.repasswd.focus();
		return false;
	} else if( ! memmodifyform.delpasswd.value ) {
		alert( passwderror );
		memmodifyform.delpasswd.focus();
		return false;
	} else if ( memmodifyform.delpasswd.value != memmodifyform.passwd.value ) {
		alert( repasswderror );
		return false;
	} else if ( memmodifyform.delpasswd.value === memmodifyform.passwd.value ) {
		alert( confirmdel );
